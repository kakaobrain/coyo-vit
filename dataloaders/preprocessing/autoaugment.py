...
from . import autoaugment_hparams
...
def distort_image_with_autoaugment(image, augmentation_name):
    ...
    augmentation_params = autoaugment_hparams.Config(cutout_const=100, translate_const=250)
...
def distort_image_with_randaugment(image, num_layers, magnitude):
    ...
    augmentation_params = autoaugment_hparams.Config(cutout_const=40, translate_const=100)
    available_ops = [
