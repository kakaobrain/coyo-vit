# https://github.com/tensorflow/models/blob/master/official/modeling/optimization/ema_optimizer.py
...
class ExponentialMovingAverage(tf.keras.optimizers.Optimizer):
    ...
    def __init__(self,
                 ...
                 trainable_weights_only: bool = False,
    ...
    def apply_gradients(self, grads_and_vars, name: Optional[Text] = None, experimental_aggregate_gradients=True):
        result = self._optimizer.apply_gradients(grads_and_vars, name, experimental_aggregate_gradients)
